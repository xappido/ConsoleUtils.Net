/*
 Slightly modified version from https://github.com/KolibriDev/clippy
 */
...
namespace ConsoleUtils.Net
{
    public class ConsoleClipboard
    {
        ...
        {
            return SetStringToClipboard(message, CF_TEXT);
        }
        ...
        [STAThread]
        private static Result SetStringToClipboard(string message, uint format)
        {
            try
            {
                try
